...
class MockData {
    ...
    static let newsArray = [
        ...
        News(id: 2, category: .Miércoles, fecha: "Mie 23", horaIni: "20:00", horaFin: "", sede: "Catedral  de la ciudad de Puebla.", direccion: "", evento: "Inauguración FIF Puebla 2016", ponente: "FIF Puebla 2016", pais: "", descripcion: "Presentación del Festival en su segunda edición con diverss presentaciones con distintos artistas."),
        ...
        News(id: 20, category: .Sábado, fecha: "Sáb 26", horaIni: "18:00", horaFin: "", sede: "UNIVERSIDAD IBERO", direccion: "Blvd. Del Niño Poblano 2901, Reserva Territorial Atlixcáyotl, 72810 San Andrés Cholula, PUE", evento: "Homenaje Pedro Meyer", ponente: "FIF Puebla", pais: "México", descripcion: ""),
